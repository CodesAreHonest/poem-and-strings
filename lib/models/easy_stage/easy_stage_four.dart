...
class EasyStageFour {
  final List<Character> stageData = [
    Character("谁", false, false, 0),
    Character("道", false, false, 1),
    Character("群", false, false, 2),
    Character("生", false, false, 3),
    Character("性", false, false, 4),
    Character("命", false, false, 5),
    Character("微", false, false, 6),
    Character("一", false, false, 7),
    Character("般", false, false, 8),
    Character("骨", false, false, 9),
    Character("肉", false, false, 10),
    Character("一", false, false, 11),
    Character("般", false, false, 12),
    Character("皮", false, false, 13)
  ];
  ...
  final String youtubeLink = 'https://www.youtube.com/watch?v=Ea6htoQplpE';
