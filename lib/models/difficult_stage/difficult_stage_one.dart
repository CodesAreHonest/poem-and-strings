...
class DifficultStageOne {
  final List<Character> stageData = [
    ...
    Character("门", false, false, 1),
    Character("万", false, false, 2),
    Character("户", false, false, 3),
    Character("曈", false, false, 4),
    Character("曈", false, false, 5),
    Character("日", false, false, 6),
    Character("总", false, false, 7),
    Character("把", false, false, 8),
    Character("新", false, false, 9),
    Character("桃", false, false, 10),
    Character("换", false, false, 11),
    Character("旧", false, false, 12),
    Character("符", false, false, 13)
  ];
