...
class DifficultStageEight {
  final List<Character> stageData = [
    Character("孤", false, false, 0),
    Character("舟", false, false, 1),
    Character("蓑", false, false, 2),
    Character("笠", false, false, 3),
    Character("翁", false, false, 4),
    Character("独", false, false, 5),
    Character("钓", false, false, 6),
    Character("寒", false, false, 7),
    Character("江", false, false, 8),
    Character("雪", false, false, 9),
  ];
