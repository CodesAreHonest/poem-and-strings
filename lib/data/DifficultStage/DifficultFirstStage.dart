...
import "./DifficultStage.dart";

class DifficultFirstStage extends DifficultStage {
  final int numOfRows = 2;

  int targetElementPosition;

  List<Character> stageData = [Character("爆", false, false, 0), Character("竹", false, false, 1), Character("声", false, false, 2), Character("中", false, false, 3), Character("一", false, false, 4), Character("岁", false, false, 5), Character("除", false, false, 6), Character("春", false, false, 7), Character("风", false, false, 8), Character("送", false, false, 9), Character("暖", false, false, 10), Character("入", false, false, 11), Character("屠", false, false, 12), Character("苏", false, false, 13)];
  ...
  int incrementStep() => ++this.stepUsed;
  ...
  Character getCharacterAtPosition(int position) => stageData.elementAt(position);
}
